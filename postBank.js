const data = [
    ...
    { id: 2, upvotes: 221, title: "Untransfiguration classes to become compulsory at Hogwarts", content: "Learning untransfiguration is going to be mandatory at Hogwarts School of Witchcraft and Wizardry from 2017 onwards. Untransfiguration will be covered in beginner-level spellbooks such as A Beginner's Guide to Transfiguration. Failure to at least attempt to untranfigure a wrongly-done transfiguration will be considered irresponsible.", name: "Baddock", date: new Date(Date.now() - 90000000) },
    ...
    { id: 4, upvotes: 171, title: "ASK WN: What do you use to digitalize your scrolls?", content: "Some scrolls need conservation treatment before they can be safely transported, handled, and digitized.  After these questions are answered, Preservation and Information Technology Specialists assess the project requirements and create the digitized version.", name: "Alphard", date: new Date(Date.now() - 5000) },
    ...
    { id: 9, upvotes: 102, title: "Conserving water plants cheatsheet.", content: "This Cheat Sheet is dedicated to providing wizards the information they want in an approachable, entertaining way.", name: "Otto", date: new Date(Date.now() - 3000000) },
    ...
    { id: 14, upvotes: 10, title: "How to tell which spell used on a bug?", content: "Question: Are there any non-jinx incantations available to detect which spell used on a bug?", name: "Lupin", date: new Date() }
  ];
